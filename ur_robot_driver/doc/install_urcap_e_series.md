...
Here you'll have to setup the IP address of the external PC which will be running the Isaac driver.

To find the IP address of the Isaac machine the following command can be used. 
