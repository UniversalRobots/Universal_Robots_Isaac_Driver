 ...
 * from the client library with Isaac logging.
 * Use registerLogHandler to register this class, shouldn't be instansiated directly.
 */
...
/*!
 * \brief Register the UrclLoghHandler, this will start logging messages from the client library with Isaac logging.
 * This function has to be called inside your node, to enable the log handler.
 */
void registerUrclLogHandler();

/*!
 * \brief Unregister the UrclLoghHandler, stop logging messages from the client library with Isaac logging.
 */
